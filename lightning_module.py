...
from donut.donut.model import DonutConfig, DonutModel
...
class DonutModelPLModule(pl.LightningModule):
    ...
    def validation_step(self, batch, batch_idx, dataloader_idx=0):
        ...
        inference_time_per_batch = time_taken
        inference_time_per_image = time_taken / batch_size
        ...
        wandb.log({
            "val_inference_time_per_batch": inference_time_per_batch,
            "val_inference_time_per_image": inference_time_per_image,
            "val_edit_distance": avg_score
